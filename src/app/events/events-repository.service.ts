  ...
  eventList: IEvent[] = [
    {
      ...
      description: [
        "This month, Frank will demonstrate some findings on how to enhance site security with some simple tweaks. We'll follow with general discussion about the projects people are working on.",
        'We will begin our monthly topic at 6pm. The Zoom link will be available up to half an hour early, for anyone who would like to socialize beforehand.',
      ],
    ...
    },
    {
      ...
      description: [
        ...
        'Join us on the 2nd and 4th Fridays of the month as we grab a morning beverage, fire up Zoom, and take time to dive into the latest dev news, share tips and tricks, and commiserate in general. This is an informal study group where we are all peers, learning from and sharing with the others. All levels of expertise are invited and welcome!',
